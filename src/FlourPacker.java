...
/*    Flour Pack Problem
    ...
    If the sum is greater than goal, ensure that only full bags are used towards the goal amount.
        ...
        big bag is 5 kilos and cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, the method
        should return true because of 1 full bigCount bag and 4 full smallCount bags equal goal, and it's okay if there
    ...
    canPack (0, 5, 4); should return true since smallCount is 5 (small bags of 1 kilo) and goal is 4 kilos, and
    ...
    /*
    * @param bigCount - 5k flour bags
    * @param smallCount - 1k flour bags
    * @param goal - amount of flour needed for package
    * */
